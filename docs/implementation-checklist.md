...
- [ ] **2.1 · Define the vendor-agnostic mention/review/article schema**
...
- [ ] **2.2 · Choose and stand up persistence**
...
- [ ] **2.3 · Service skeleton with proper config and secrets handling**
...
- [ ] **2.4 · Build the ingestion run ledger**
...
- [ ] **2.5 · Idempotent upsert keyed on (source, external_id)**
...
- [ ] **2.6 · Migrations from the first schema commit**
